  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        <div className="mb-8">
          <Link href="/admin/categories" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <ImageUpload
                  ...
                  maxImages={1}
                />
                <p className="text-sm text-gray-500 mt-1">Upload a category image</p>
              </div>
