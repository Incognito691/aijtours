...
export default function NewPackagePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const packageData = {
        ...
        dailyItinerary: formData.dailyItinerary.filter((item) => item.trim() !== ""),
        images,
        tags,
      }
  ...
  const handleArrayChange = (index: number, value: string, field: "included" | "excluded" | "dailyItinerary") => {
    setFormData((prev) => ({
      ...prev,
  ...
  const removeArrayItem = (index: number, field: "included" | "excluded" | "dailyItinerary") => {
    setFormData((prev) => ({
      ...prev,
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-6">
        <div className="mb-8">
          <Link href="/admin/packages" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4">
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Packages
          </Link>
          <h1 className="text-3xl font-bold text-gray-900">Create New Package</h1>
          <p className="text-gray-600 mt-2">Add a new travel package to your catalog</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs text-gray-500">(Will appear in Limited Offers section on homepage)</span>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload images for your package (first image will be the main image)</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>List what's not included in the package</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                ...
                <Button type="button" variant="outline" onClick={() => addArrayItem("excluded")}>
                  <Plus className="h-4 w-4 mr-2" />
                  Add Item
                </Button>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Describe the daily activities (optional)</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                {formData.dailyItinerary.map((item, index) => (
                  <div key={index} className="flex gap-2">
                    ...
                    <Input
                      value={item}
                      onChange={(e) => handleArrayChange(index, e.target.value, "dailyItinerary")}
                ...
                <Button type="button" variant="outline" onClick={() => addArrayItem("dailyItinerary")}>
                  <Plus className="h-4 w-4 mr-2" />
                  Add Day
                </Button>
              </div>
